...
func SetObjectDefaults_Pod(in *Pod) {
	...
	for i := range in.Spec.Volumes {
		...
		if a.VolumeSource.SystemProjection != nil {
			SetDefaults_SystemProjections(a.VolumeSource.SystemProjection)
			for j := range a.VolumeSource.SystemProjection.Sources {
				b := &a.VolumeSource.SystemProjection.Sources[j]
				if b.Secret != nil {
					SetDefaults_SecretVolumeSource(b.Secret)
				}
				if b.DownwardAPI != nil {
					SetDefaults_DownwardAPIVolumeSource(b.DownwardAPI)
				...
				if b.ConfigMap != nil {
					SetDefaults_ConfigMapVolumeSource(b.ConfigMap)
				}
			}
		}
	}
